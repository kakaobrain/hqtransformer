...
INCEPTION_PATH = '/data/project/rw/pretrained/inception-v3/pt_inception-2015-12-05-6726825d.pth'


def set_inception_path(path):
    global INCEPTION_PATH
    INCEPTION_PATH = path
...
def fid_inception_v3():
    ...
    inception.load_state_dict(torch.load(INCEPTION_PATH), strict=True)
